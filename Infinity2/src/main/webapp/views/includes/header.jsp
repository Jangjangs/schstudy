          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu animated flipInY">
                ...
                <li>
                  <a class="text-color" href="settings">
  ...
  <div class="menubar-scroll">
    <div class="menubar-scroll-inner">
      <ul class="app-menu">
          ...
          <ul class="submenu">
            <li><a href="MemberList"><span class="menu-text">회원관리</span></a></li>
            <li><a href="MemberOutList"><span class="menu-text">탈퇴회원</span></a></li>
          </ul>
        </li> 
          ...
          <ul class="submenu">
            <li><a href="List"><span class="menu-text">게시판</span></a></li>
             <li><a href="Gallery"><span class="menu-text">갤러리</span></a></li>
          </ul>
          </li>
