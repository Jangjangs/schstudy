    ...
    <div class="menubar-scroll-inner">
      <ul class="app-menu">
        ...
        <li class="has-submenu">
          ...
          <ul class="submenu">
            <li><a href="/resources/default/index.html"><span class="menu-text">Default</span></a></li>
            <li><a href="/resources/topbar/index.html"><span class="menu-text">Topbar</span></a></li>
          </ul>
        </li>
